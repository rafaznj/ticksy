...
const ticket_priority_enum_1 = require("../../../modules/ticket/enums/ticket-priority.enum");
const user_schema_1 = require("./user.schema");
const ticket_status_enum_1 = require("../../../modules/ticket/enums/ticket-status.enum");
exports.ticketStatusEnum = (0, pg_core_1.pgEnum)("ticket_status", Object.values(ticket_status_enum_1.TicketStatusEnum));
exports.ticketPriorityEnum = (0, pg_core_1.pgEnum)("ticket_priority", Object.values(ticket_priority_enum_1.TicketPriorityEnum));
exports.ticket = (0, pg_core_1.pgTable)("ticket", {
    ...
    status: (0, exports.ticketStatusEnum)().default(ticket_status_enum_1.TicketStatusEnum.OPEN).notNull(),
