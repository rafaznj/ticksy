...
exports.ticketStatusEnum = (0, pg_core_1.pgEnum)("ticket_status", Object.values(ticket_enum_1.TicketStatus));
exports.ticketPriorityEnum = (0, pg_core_1.pgEnum)("ticket_priority", Object.values(ticket_enum_1.TicketPriority));
exports.ticket = (0, pg_core_1.pgTable)("ticket", {
    ...
    status: (0, exports.ticketStatusEnum)().default(ticket_enum_1.TicketStatus.OPEN).notNull(),
