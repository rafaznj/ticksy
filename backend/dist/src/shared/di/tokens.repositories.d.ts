export declare const REPOSITORY_TOKENS: {
    readonly CreateUserRepository: symbol;
    ...
    readonly DeleteTicketRepository: symbol;
    readonly GetTicketByIdRepository: symbol;
    readonly GetTicketPagedRepository: symbol;
};
