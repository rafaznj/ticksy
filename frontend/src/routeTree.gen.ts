...
const AuthenticatedTicketsWaitingRoute = AuthenticatedTicketsWaitingRouteImport.update({
  id: "/tickets/waiting",
...
const AuthenticatedTicketsFinishedRoute = AuthenticatedTicketsFinishedRouteImport.update({
  id: "/tickets/finished",
